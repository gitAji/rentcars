  ...
  return (
    <header className="p-4 flex justify-between items-center bg-neutral text-white">
      <div className="flex gap-4 items-center">
        <Link href="/admin" className="hover:text-red-500 cursor-pointer">Admin Dashboard</Link>
      </div>
      <nav className="flex gap-4 items-center">
        <Link href="/admin/cars/new" className="hover:text-red-500 cursor-pointer">Add Car</Link>
